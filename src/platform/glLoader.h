...
typedef void*(RENDER_GLAPI* PFNGLMAPBUFFERRANGEPROC)(
...
typedef void(RENDER_GLAPI* PFNGLCOPYBUFFERSUBDATAPROC)(
...
typedef void(RENDER_GLAPI* PFNGLDRAWELEMENTSINSTANCEDPROC)(
...
typedef void(RENDER_GLAPI* PFNGLSHADERBINARYPROC)(
    GLsizei count, const GLuint* shaders, GLenum binaryformat, const void* binary, GLsizei length);
typedef void(RENDER_GLAPI* PFNGLSPECIALIZESHADERPROC)(GLuint shader,
    const GLchar* pEntryPoint,
    GLuint numSpecializationConstants,
    const GLuint* pConstantIndex,
    const GLuint* pConstantValue);
typedef void(RENDER_GLAPI* PFNGLNAMEDBUFFERSTORAGEPROC)(
...
typedef void(RENDER_GLAPI* PFNGLSHADERSOURCEPROC)(
...
typedef void(RENDER_GLAPI* PFNGLGETPROGRAMINFOLOGPROC)(
...
typedef void(RENDER_GLAPI* PFNGLUNIFORMMATRIX3FVPROC)(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
typedef void(RENDER_GLAPI* PFNGLUNIFORMMATRIX4FVPROC)(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
...
typedef void(RENDER_GLAPI* PFNGLTEXIMAGE2DPROC)(GLenum target,
    GLint level,
    ...
    GLenum type,
    const void* pixels);
typedef void(RENDER_GLAPI* PFNGLTEXSUBIMAGE2DPROC)(GLenum target,
    GLint level,
    GLint xoffset,
    GLint yoffset,
    GLsizei width,
...
typedef void(RENDER_GLAPI* PFNGLNAMEDBUFFERSUBDATAPROC)(
    GLuint buffer, GLintptr offset, GLsizeiptr size, const void* data);
typedef void*(RENDER_GLAPI* PFNGLMAPNAMEDBUFFERRANGEPROC)(
...
typedef void(RENDER_GLAPI* PFNGLCOPYNAMEDBUFFERSUBDATAPROC)(
...
typedef void(RENDER_GLAPI* PFNGLTEXTURESTORAGE2DPROC)(
    GLuint texture, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height);
typedef void(RENDER_GLAPI* PFNGLTEXTURESUBIMAGE2DPROC)(GLuint texture,
    GLint level,
    GLint xoffset,
    GLint yoffset,
    GLsizei width,
...
typedef void(RENDER_GLAPI* PFNGLVERTEXARRAYATTRIBFORMATPROC)(
    GLuint vaobj, GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset);
typedef void(RENDER_GLAPI* PFNGLVERTEXARRAYVERTEXBUFFERPROC)(
...
typedef void(RENDER_GLAPI* PFNGLBINDBUFFERRANGEPROC)(
